                        ...
                        parameters: [
                            {
                                name: 'diff',
                                schemar: {
                                    description: '.patch file format without the line numbers',
                                    type: 'string'
                                },
                                required: false,
                            }
   ...
   return 0;
                    ...
                    for (let attempt = 0; attempt < maxRetries; attempt++) {
                        try {
                            ...
                            console.log(error);
                            diff = null;
                            await respondToPrompt(`Applying the diff failed with error:\n${error}\nWhat did you do wrong? How can you fix this? Bare in mind that things like indentation must match exactly for this to work.`);
        ...
        changeFeatureState(feature, true, 'Unhandled error', error.toString());
    }
